...
# ------------------------------------------------------------------
        ...
        api_lambda = lambda_.Function(
            ...
            environment={
                ...
                "EMAIL_PROVIDER_PARAM": f"/{project_name}/{environment}/email-provider",
                "SMTP_HOST_PARAM": f"/{project_name}/{environment}/smtp-host",
                "SMTP_PORT_PARAM": f"/{project_name}/{environment}/smtp-port",
                "SMTP_USERNAME_PARAM": f"/{project_name}/{environment}/smtp-username",
                "SMTP_PASSWORD_PARAM": f"/{project_name}/{environment}/smtp-password",
